...
type (
	...
	UserGroup struct {
		...
		Permission int64  `db:"permission"` // 0:群主,1:管理员,2:群员,3:禁言
...
func (m *defaultUserGroupModel) FindOneByUserIdGroupId(ctx context.Context, userId int64, groupId int64) (*UserGroup, error) {
	...
	var resp UserGroup
	err := m.QueryRowIndexCtx(ctx, &resp, userGroupUserIdGroupIdKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultUserGroupModel) Insert(ctx context.Context, data *UserGroup) (sql.Result, error) {
	...
	ret, err := m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, data.UserId, data.GroupId, data.Permission, data.Remark)
	}, userGroupIdKey, userGroupUserIdGroupIdKey)
	return ret, err
}
...
func (m *defaultUserGroupModel) Update(ctx context.Context, newData *UserGroup) error {
	...
	_, err = m.ExecCtx(ctx, func(ctx context.Context, conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.ExecCtx(ctx, query, newData.UserId, newData.GroupId, newData.Permission, newData.Remark, newData.Id)
	}, userGroupIdKey, userGroupUserIdGroupIdKey)
	return err
}
